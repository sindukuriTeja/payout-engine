        ...
        <div className="mt-12 bg-gray-50 rounded-3xl p-8 border border-gray-100 shadow-sm relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <h3 className="text-2xl font-bold text-gray-400 text-center uppercase tracking-widest">Traditional Systems</h3>
              {comparisons.map((item, idx) => (
                <div key={idx} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4 grayscale opacity-60">
